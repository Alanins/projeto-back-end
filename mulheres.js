...
const cors = require('cors')//estou trazendo o pacote corns que permite consumir essa api no frontend
...
app.use(router.delete('/mulheres/:id', deletaMulher))// configurei rota DELERE /mulheres/:id
